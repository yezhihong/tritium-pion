...
Double_t gGet_BeamCharge_Avg(TTree *aT_Tree,const TString& aArm){
    ...
    if(aArm =="L"){
        ...
        Double_t bcm_uc = aT_Tree->GetMaximum(LEFT_BCM_U.Data()) - aT_Tree->GetMinimum(LEFT_BCM_U.Data());
        Double_t bcm_dc = aT_Tree->GetMaximum(LEFT_BCM_D.Data()) - aT_Tree->GetMinimum(LEFT_BCM_D.Data());
        ...
        Double_t bcm_uc = aT_Tree->GetMaximum(RIGHT_BCM_U.Data()) - aT_Tree->GetMinimum(RIGHT_BCM_U.Data());
        Double_t bcm_dc = aT_Tree->GetMaximum(RIGHT_BCM_D.Data()) - aT_Tree->GetMinimum(RIGHT_BCM_D.Data());
